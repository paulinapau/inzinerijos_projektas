...
var useCreateUserWithEmailAndPassword = (function (auth$1, options) {
    ...
    var createUserWithEmailAndPassword = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
        var user, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
var useSendEmailVerification = (function (auth$1) {
    ...
    var sendEmailVerification = function () { return __awaiter(void 0, void 0, void 0, function () {
        var err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
var useSendPasswordResetEmail = (function (auth$1) {
    var _a = react.useState(), error = _a[0], setError = _a[1];
    var _b = react.useState(false), loading = _b[0], setLoading = _b[1];
    var sendPasswordResetEmail = function (email) { return __awaiter(void 0, void 0, void 0, function () {
        var err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, auth.sendPasswordResetEmail(auth$1, email)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 3:
...
var useUpdateEmail = function (auth$1) {
    var _a = react.useState(), error = _a[0], setError = _a[1];
    var _b = react.useState(false), loading = _b[0], setLoading = _b[1];
    var updateEmail = function (email) { return __awaiter(void 0, void 0, void 0, function () {
        var err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var resArray = [updateEmail, loading, error];
    return react.useMemo(function () { return resArray; }, resArray);
};
var useUpdatePassword = function (auth$1) {
    var _a = react.useState(), error = _a[0], setError = _a[1];
    var _b = react.useState(false), loading = _b[0], setLoading = _b[1];
    var updatePassword = function (password) { return __awaiter(void 0, void 0, void 0, function () {
        var err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var resArray = [updatePassword, loading, error];
    return react.useMemo(function () { return resArray; }, resArray);
};
var useUpdateProfile = function (auth$1) {
    ...
    var resArray = [updateProfile, loading, error];
    return react.useMemo(function () { return resArray; }, resArray);
};
